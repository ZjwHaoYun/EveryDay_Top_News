...
# async def get_data_from_zhihu() -> None:
#     # 请求参数
#     params = (
#         ('limit', '50'),
#         ('reverse_order', '0'),
...
#         }
#     # 发送请求
#     url = 'https://zhihu.com/topstory/hot-list'
#     response = await async_fetch(crawl_name='知乎',url=url,headers=headers,params=params)
#     print(response)
#     items = response['data']
#     result = []
#     # 遍历全部热榜，取出几个属性
...
if __name__ == "__main__":
    ...
    try:
        res = asyncio.run(get_data_from_zhihu())
